...
public class TrigonometricRiverFromSavedProblem extends AppCompatActivity {
...
//                startActivity(intent);
                ...
                Intent intent = new Intent(TrigonometricRiverFromSavedProblem.this,TestSimpletrigOutput.class);
    ...
    public void savedProblem()
    {
        if (getIntent().hasExtra("side1")) {
            side.setText(it.getStringExtra("side1"));
            angle.setText(it.getStringExtra("angle1"));
        } else {
