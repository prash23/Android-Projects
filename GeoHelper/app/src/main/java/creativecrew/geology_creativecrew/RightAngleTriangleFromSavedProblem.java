...
public class RightAngleTriangleFromSavedProblem extends AppCompatActivity {
...
//               intent.putExtra("units",unit_selected);
    ...
    public void savedProblem()
    {
        if (getIntent().hasExtra("valA")) {
            side1.setText(it.getStringExtra("valA"));
            side2.setText(it.getStringExtra("valB"));
            side3.setText(it.getStringExtra("valC"));
        } else {
