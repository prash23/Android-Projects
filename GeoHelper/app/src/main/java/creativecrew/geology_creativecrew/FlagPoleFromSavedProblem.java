...
/**
 * Created by Prashanth on 12/8/2016.
 */

public class FlagPoleFromSavedProblem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(FlagPoleFromSavedProblem.this, TestAcute.class);
...
//                intent.putExtra("units",unit_selected);
    ...
    public void savedProblem()
    {
        if (getIntent().hasExtra("valEA")) {
            angle1.setText(it.getStringExtra("valEA"));
            angle2.setText(it.getStringExtra("valBC"));
            side1.setText(it.getStringExtra("valB"));
            side2.setText(it.getStringExtra("valD"));
        } else {
