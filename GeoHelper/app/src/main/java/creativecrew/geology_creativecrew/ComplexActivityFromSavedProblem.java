...
public class ComplexActivityFromSavedProblem extends AppCompatActivity {
...
//               intent.putExtra("units",unit_selected);
    ...
    public void savedProblem()
    {
        if (getIntent().hasExtra("side")) {
            side.setText(it.getStringExtra("side"));
            angABC.setText(it.getStringExtra("angleABC"));
            angACD.setText(it.getStringExtra("angleACD"));
        } else {
